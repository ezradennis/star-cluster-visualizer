...
Goals:
	 ...
	 - Have some amount of educational value, where this could be given to some student to visualize the star cluster they're learning about
	

Current Status:

	- Has pre-imported data from the hyg database (~ 130,000 stars)
	- Fans on my laptop go Mach-10 when loading this (will probably be better for clusters, not 130,000 stars, which is more than I ever originally meant to load at once)
